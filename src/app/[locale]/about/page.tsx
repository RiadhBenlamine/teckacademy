      ...
      <div className="max-w-5xl mx-auto px-5 sm:px-8 lg:px-10">
        ...
        <div className="mb-16">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {whyUsCards.map((card) => (
              <Card key={card.id} className="p-6 border-slate-200/90 flex gap-4 items-start">
                <div className="w-12 h-12 rounded-2xl bg-slate-50 border border-slate-200/70 flex items-center justify-center shrink-0">
