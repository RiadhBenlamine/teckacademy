      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {ageGroupsData.map((group) => (
            <Card
              key={group.id}
              className="flex flex-col justify-between border-slate-200/90 group hover:border-blue-400/40 p-6 relative overflow-hidden"
            >
              {/* Top Accent Strip */}
              ...
              <div>
                ...
                <div className="flex items-center justify-between mb-4">
                  <div className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-slate-100 text-slate-900 font-extrabold text-base sm:text-lg border border-slate-200/80 shadow-2xs">
                ...
                {/* Description */}
                <p className="mt-2.5 text-xs sm:text-sm text-slate-600 leading-relaxed min-h-[56px]">
