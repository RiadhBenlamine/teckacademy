...
export function Journey({ locale }: { locale: Locale }) {
  ...
  return (
    <section id="journey" className="py-16 md:py-24 bg-white dark:bg-[#090d16] transition-colors">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 lg:px-10">
        ...
        <div className="hidden lg:block relative mt-16 mb-8">
          ...
          <div className="absolute top-7 inset-x-8 h-1 bg-gradient-to-r from-blue-200 via-cyan-300 to-indigo-300 dark:from-blue-900/60 dark:via-cyan-800/60 dark:to-indigo-900/60 -z-0 rounded-full" />

          <div className="grid grid-cols-6 gap-4 relative z-10">
            {journeySteps.map((step) => (
              <div key={step.step} className="flex flex-col items-center text-center group">
                {/* Numbered Node Circle */}
                <div className="w-14 h-14 rounded-2xl bg-white dark:bg-slate-900 border-2 border-blue-500 shadow-md group-hover:border-cyan-500 group-hover:shadow-blue-500/20 group-hover:scale-110 flex items-center justify-center transition-all duration-300 mb-5 relative">
                ...
                {/* Step Card Content */}
                <div className="bg-slate-50/80 dark:bg-slate-900/90 group-hover:bg-blue-50/50 dark:group-hover:bg-blue-950/40 border border-slate-200/80 dark:border-slate-800 group-hover:border-blue-200 dark:group-hover:border-blue-800 p-4 rounded-2xl transition-all duration-200 w-full min-h-[160px] flex flex-col items-center">
        ...
        <div className="lg:hidden relative mt-8 space-y-6">
          ...
          <div
            ...
            } w-0.5 bg-gradient-to-b from-blue-400 via-cyan-400 to-indigo-400 dark:from-blue-600 dark:via-cyan-600 dark:to-indigo-600`}
          />
          ...
          {journeySteps.map((step) => (
            ...
            >
              ...
              <div className="relative z-10 shrink-0 w-12 h-12 rounded-2xl bg-white dark:bg-slate-900 border-2 border-blue-600 shadow-md flex items-center justify-center">
                {getStepIcon(step.icon)}
              ...
              {/* Card */}
              <div className="flex-1 bg-slate-50 dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 p-5 rounded-2xl shadow-2xs">
